...
/**
 * Class ShippingFee file.
 */
class ShippingFee implements ArrayInterface
{
    public const FREE_SHIPPING_SUBTOTAL = 'carriers/freeshipping/free_shipping_subtotal';
    ...
    {
        $get_pages = $this->_scopeConfigInterface->getValue(
            self::FREE_SHIPPING_SUBTOTAL,
            ScopeInterface::SCOPE_STORE
        );

        return [
            ['value' => $get_pages, 'label' => __($get_pages)],
        ];
    }
}
